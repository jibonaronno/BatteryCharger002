...
#define		CHECKPIN1	if(!(digitalRead(INPIN1)))
#define		CHECKPIN2	if(!(digitalRead(INPIN2)))
#define		CHECKPIN3	if(!(digitalRead(INPIN3)))
#define		CHECKPIN4	if(!(digitalRead(INPIN4)))
